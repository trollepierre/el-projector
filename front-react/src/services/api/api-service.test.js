...
describe('apiService', () => {
  ...
  beforeEach(() => {
    ...
    token.getAccessToken = jest.fn();
    token.getAccessToken.mockReturnValue('token');
  });
  ...
  describe('get', () => {
    ...
    describe('when the promise resolves data', () => {
      ...
      it('should call the correct API status endpoint', async () => {
        ...
        // Then
        expect(axios.get).toHaveBeenCalledWith(url, { "headers": { "Authorization": "Bearer token", "json": true } });
      });
  ...
  describe('post', () => {
    ...
    describe('when the promise resolves data', () => {
      ...
      it('should call the correct API status endpoint', async () => {
        ...
        // Then
        expect(axios.post).toHaveBeenCalledWith(url, { json: true });
      });
    ...
    describe('when the promise rejects', () => {
      ...
      it('should log the error', async () => {
        ...
        // Then
        expect(logger.error).toHaveBeenCalledWith('Async error');
      });
    });
  });
  ...
  describe('put', () => {
    ...
    describe('when the promise resolves data', () => {
      ...
      it('should call the correct API status endpoint', async () => {
        ...
        // Then
        expect(axios.patch).toHaveBeenCalledWith(url, { json: true });
      });
